...
<script>
	function getXls()
	{
		...
		{	
			...
			document.location = "?location=svfl_gexls&nohead=true&client=<?=$_GET['client']?>&date=" + _date + "&group=" + _group ;
		}
	}
</script>
<form method="GET" action="?location=svfl_gexls&client=<?=$_GET['client']?>&">
<table class="titulo">
	<tr>
		<td align="center" colspan="2" style="font-size: 18;font-family: Arial, Helvetica, sans-serif;">Grillas mensuales de Superview<br><br></td>
	</tr>
	 <tr>
	 	<td>Grupo:</td>
