...
<form name="f" method="post" action="?location=ccfl_gwxml&date=<?=$_GET['date']?>&id=<?=$_GET['id']?>&nohead=true">
...
<form id="backform" method="post" action="?location=ccfl_chkl&date=<?=$_GET['date']?>&id=<?=$_GET['id']?>" ><input type="hidden" name="ids" value="<?=implode(",", $_POST['specials'])?>" ></form>