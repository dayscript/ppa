...
?>
      <TR height="20">
  			...
  			<img src="<?=( $channels[$row['channel']]['logo'] != "" ? "http://200.71.33.249/~ppa/ppa/" . $channels[$row['channel']]['logo'] : "images/empty.gif" )?>"/><div><?= $channels[$row['channel']]['name'] ."<br>". $channels[$row['channel']]['number'] ?></div></TD>
