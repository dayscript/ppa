...
function MTMDisplayMenu() {
	if(MTMUA.MTMable && !MTMUpdating) {
		...
		if(MTMUA.DOMable) {
			...
			if(MTMLinkedSS) {
				MTMOutputString += '<link rel="stylesheet" type="text/css" href="../../../editor_mozilla/archivos/%27%20%2B%20MTMUA.preHREF%20%2B%20MTMSSHREF%20%2B%20%27">\n';
			} else {
		...
		MTMOutputString = '<img src="../../../editor_mozilla/archivos/%27%20%2B%20MTMUA.preHREF%20%2B%20MTMenuImageDirectory%20%2B%20MTMRootIcon%20%2B%20%27" align="left" border="0" vspace="0" hspace="0">';
		if(MTMUA.cssEnabled) {
...
function MTMakeImage(thisImage) {
	return('<img src="../../../editor_mozilla/archivos/%27%20%2B%20MTMUA.preHREF%20%2B%20MTMenuImageDirectory%20%2B%20thisImage%20%2B%20%27" align="left" border="0" vspace="0" hspace="0" width="18" height="18">');
}
