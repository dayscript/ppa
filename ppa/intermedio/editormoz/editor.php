...
<body onLoad="javascript:enableEdit();" >
  	...
  	<tr>
		<td style="background: buttonface;" >
			<img class="button"
 				...
 				src="../editormoz/images/archivo.bmp"
 				id="archivo"
 				align="middle"
 			>
		</td>
  ...
  <div id="toolbar"> <img src="../editormoz/images/linea.gif" align="middle" > <img class="button"
 	onmouseover="mouseover(this);"
 	onmouseout="mouseout(this);"
 	onmousedown="mousedown(this);"
 	onmouseup="mouseup(this);"
 	onclick="cambiarEstilo('Bold');"
 	src="../editormoz/images/bold.gif"
 	width="16" height="16"
 	align="middle"
 	> <img class="button"
 	onmouseover="mouseover(this);"
 	...
 	src="../editormoz/images/italic.gif"
 	width="16" height="16"
 	align="middle"
 	> <img class="button"
 	onmouseover="mouseover(this);"
 	...
 	src="../editormoz/images/under.gif"
 	width="24" height="24"
 	align="middle"
	> <img src="../editormoz/images/linea.gif" align="middle"> <img class="button"
 	onmouseover="mouseover(this);"
 	onmouseout="mouseout(this);"
 	onmousedown="mousedown(this);"
 	onmouseup="mouseup(this);"
 	onclick="url();"
 	src="../editormoz/images/link.gif"
 	width="32" height="16"
 	align="middle"
 	> <img class="button"
 	onmouseover="mouseover(this);"
 	...
 	onmouseup="mouseup(this);"
 	onclick="image();"
 	src="../editormoz/images/image.gif"
 	width="24" height="24"
 	align="middle"
 	> <img src="../editormoz/images/linea.gif" align="middle" > <img class="button"
 	onmouseover="mouseover(this);"
 	...
 	src="../editormoz/images/inindent.gif"
 	width="24" height="24"
 	align="middle"
 	> <img src="../editormoz/images/linea.gif" align="middle" > <img class="button"
 	onmouseover="mouseover(this);"
 	...
 	src="../editormoz/images/paste.gif"
 	width="24" height="24"
 	align="middle"
 	> <img src="../editormoz/images/linea.gif" align="middle" > <img class="button"
 	onmouseover="mouseover(this);"
 	...
 	src="../editormoz/images/center.gif"
 	width="24" height="24"
 	align="middle"
 	> <img class="button"
 	onmouseover="mouseover(this);"
 	...
 	src="../editormoz/images/right.gif"
 	width="24" height="24"
 	align="middle"
 	> <img src="../editormoz/images/linea.gif" align="middle" > 
