<?=print_r( $_POST )?>
<form name="choose" action="intermedio.php" method="post">
<table>
<tr>
<td>
Escoja una letra:
...
<input type="hidden" name="show_sinop" value="<?=$_POST['show_sinopsis']?>">
...
$sql = "SELECT s.chapter FROM sinopsis s, chapter c where year = '".$_POST['ano1']."' and month = '".$_POST['mes1']."' and s.chapter = c.id order by c.title";
$query = db_query( $sql );
