...
require_once($path . "class/Chapter.class.php");
	...
	*************************************************/
		...
		**/
		function Movie ( $aId = false, $aTitle = false, $aSpanishTitle = false, $aEnglishTitle = false, $aGender = false, $aRated = false, $aYear = false, $aActors = false, $aDirector = false, $aDescription = false, $aCountry = false, $aLanguage = false, $aPPA = false, $aChapters = false )	{
		...
		**/
		function commit () {
			if ($this->id)	{
				...
				$sql .=" englishTitle = '$this->englishTitle',";
				$sql .=" gender = '$this->gender',";
				$sql .=" rated = '$this->rated',";
				$sql .=" year = '$this->year',";
				$sql .=" actors = '$this->actors',";
				...
				$sql = " INSERT INTO movie (  title, spanishTitle, englishTitle, gender, rated, year, actors, director, description, country, language, PPA ) VALUES ( '$this->title', '$this->spanishTitle', '$this->englishTitle', '$this->gender', '$this->rated', '$this->year', '$this->actors', '$this->director', '$this->description', '$this->country', '$this->language', $this->PPA )";
				db_query($sql);
