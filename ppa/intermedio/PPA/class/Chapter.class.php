		...
		**/
		function commit ()	{
			if ($this->id)	{
				...
				$sql = " INSERT INTO Chapter (  title, spanishTitle, number, description, duration, stereo, surround, sap, closeCaption, animated, blackAndWhite, repetition, onLive, nudity, ofensiveLanguage, violence, adultContent, points, movie, special, serie ) VALUES ( '$this->title', '$this->spanishTitle', $this->number, '$this->description', '$this->duration', '$this->stereo', '$this->surround', '$this->sap', '$this->closeCaption', '$this->animated', '$this->blackAndWhite', '$this->repetition', '$this->onLive', '$this->nudity', '$this->ofensiveLanguage', '$this->violence', '$this->adultContent', '$this->points', '$this->movie', '$this->special', '$this->serie' )";
				db_query($sql);
