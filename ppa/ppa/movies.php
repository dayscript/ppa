...
?>
  <form name="f1" enctype="multipart/form-data" action="<?=$_SERVER['PHP_SELF']?>" method="post">
    ...
    <tr> 
      <td><div align="right"><strong>Descripción Corta</strong></div></td>
      <td>&nbsp;</td>
      <td> <div align="left"> 
    ...
    <tr> 
      <td><div align="right"><strong>Descripción Larga</strong></div></td>
      <td>&nbsp;</td>
      <td> <div align="left"> 
    ...
    <tr> 
      ...
      <td> <div align="left"> 
          <select name="language" class="large">
				<option <?=($language=="Alemán"?"selected":"")?> value="Alemán">Alemán</option>
				<option <?=($language=="Cantonese"?"selected":"")?> value="Cantonese">Cantonese</option>
				<option <?=($language=="Catalán"?"selected":"")?> value="Catalán">Catalán</option>
				...
				<option <?=($language=="Danés"?"selected":"")?> value="Danés">Danés</option>
				...
				<option <?=($language=="Francés"?"selected":"")?> value="Francés">Francés</option>
				<option <?=($language=="Hebreo"?"selected":"")?> value="Hebreo">Hebreo</option>
				<option <?=($language=="Hindú"?"selected":"")?> value="Hindú">Hindú</option>						       
				<option <?=($language=="Holandés"?"selected":"")?> value="Holandés">Holandés</option>
				<option <?=($language=="Húngaro"?"selected":"")?> value="Húngaro">Húngaro</option>
				<option <?=($language=="Inglés"?"selected":"")?> value="Inglés">Inglés</option>
				<option <?=($language=="Iraní"?"selected":"")?> value="Iraní">Iraní</option>
				<option <?=($language=="Italiano"?"selected":"")?> value="Italiano">Italiano</option>
				<option <?=($language=="Japonés"?"selected":"")?> value="Japonés">Japonés</option>						
				<option <?=($language=="Mandarín"?"selected":"")?> value="Mandarín">Mandarín</option>						
				<option <?=($language=="Polaco"?"selected":"")?> value="Polaco">Polaco</option>						
				<option <?=($language=="Portugués"?"selected":"")?> value="Portugués">Portugués</option>
