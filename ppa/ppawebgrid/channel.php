...
//	$output .= '<tr class="cat_table_title"><td colspan="2">' . ( ( $channelArr['logo'] != "" ) ? ( '<img src="http://190.27.201.2/~ppa/ppa/' . $channelArr['logo'] . '">' ) : ( $channelArr['name'] ) ) . '</td></tr>';
//	$output .= '<tr class="cat_table_title"><td colspan="2">' . ( ( $channel->getLogo() != "" ) ? ( '<img src="http://190.27.201.2/~ppa/ppa/' .  $channel->getLogo() . '">' ) : ( $channel->getName() ) ) . '</td></tr>';
	$output .= '<tr class="cat_td_title_1"><td colspan="2"><img src="' . ( $channelArr['logo'] != "" ? "http://" . $URL_PPA . "/ppa/ppa/" . $channelArr['logo'] : "images/empty.gif" ) . '"/><div>' . ( $channelArr['name'] . '<br>' . $channelArr['number'] ) .'</div></td></tr>';
//	$output .= '<img src="' . ( $row['logo'] != "" ? "http://190.27.201.2/~ppa/ppa/" . $row['logo'] : "images/empty.gif" ) . '"/><div>' . ( $channel->getName() . '<br>' . $row['number'] ) .'</div>';
