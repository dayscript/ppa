...
?>
  ...
  <tr >
    ...
    <td align="center">
	  <div style="border-style: solid; border-width: thin; width: 200; cursor: pointer; background-color: rgb(255, 255, 255);" onmouseover="this.style.backgroundColor='#ffffff';" onmouseout="this.style.backgroundColor='#ffffff';" id="show_date"><?=date('Y-m-d s:i', $date)?></div>
