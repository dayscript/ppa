<?
	...
	$menuTree = $manager->createTreeFromSource( "../", $manager->getAllowMenus( $_GET['id_group'] ) );
?>
<script>
	var URLBaseLive = "../";
</script>
...
<div id="menuDerecho" class="inicial" onMouseOver="clearTimeOutMenu();" onMouseOut="initTimeOutMenu();" >
	<table width="128" cellspacing="0" cellpadding="2" border="0" >
		<tr><td width="124" class="textos" onClick="quitarPermitidoMenu( <?= $_GET['id_group'] ?> );" onMouseOver="changeColor(this, '#FFEF03', '#000000' );" onMouseOut="changeColor(this, '', '#FFFFFF' )">&nbsp;Quitar este menu</td></tr>
	</table>
</div>